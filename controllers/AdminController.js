...
module.exports = class AdminController {
   ...
   async fetchDepartmentById(id) {
    ...
    updateDepartment(req, res) {
        ...
        res.render('admin/department-details', {title:'Add Department',message:'Department Successfully Update',alert:'alert-info'}) ;
        // res.send("sucess"); /department-details/:apo
